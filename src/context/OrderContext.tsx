...
interface OrderContextType {
  ...
  placeOrder: (shippingAddress: ShippingAddress, items: CartItem[], paymentMethod: string, couponCode?: string, paymentTerm?: string) => Promise<Order>;
...
export const OrderProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const placeOrder = async (shippingAddress: ShippingAddress, items: CartItem[], paymentMethod: string, couponCode?: string, paymentTerm?: string): Promise<Order> => {

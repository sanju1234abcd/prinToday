        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap md:flex-nowrap items-center justify-between py-2 md:h-20 gap-x-3 gap-y-2">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
              ...
              {user ? (
                <div className="relative group">
                  <button className="flex items-center space-x-1.5 px-2.5 sm:px-3.5 py-2 bg-slate-100 text-slate-800 text-xs font-bold rounded-xl hover:bg-slate-200 transition">
                    <User className="w-4 h-4 sm:w-3.5 sm:h-3.5 text-brand-blue" />
                    <span className="hidden sm:inline">{user.individual?.name || user.organization?.companyName || 'Profile'}</span>
                  </button>
                ...
                <button
                  ...
                  className="flex items-center space-x-1.5 px-2.5 sm:px-3.5 py-2 bg-gradient-to-r from-brand-blue to-brand-navy text-white text-xs font-bold rounded-xl shadow hover:shadow-glow-blue transition"
                >
                  <User className="w-4 h-4 sm:w-3.5 sm:h-3.5 text-brand-green" />
            ...
            <div className="order-[5] w-full sm:hidden flex items-center justify-between border-t border-b border-slate-100 py-2 px-3 bg-transparent text-[12.5px] font-medium text-slate-600">
              ...
              <span className="flex items-center gap-1.5">
                <span className="text-brand-green">📞</span>
                <span>Contact: <strong className="text-slate-800">9432954099</strong></span>
              </span>
            </div>
